...
' PLUS variation where right mouse button goes directly
' to max or min.
...
Public Sub HSLEF_MouseDown(HScr As Control, thumb As CommandButton, Index As Integer, _
 Button As Integer)
...
Public Sub HSRIT_MouseDown(HScr As Control, thumb As CommandButton, Index As Integer, _
 Button As Integer)
...
Public Sub VSTOP_MouseDown(VScr As Control, thumb As CommandButton, Index As Integer, _
 Button As Integer)
...
Public Sub VSBOT_MouseDown(VScr As Control, thumb As CommandButton, Index As Integer, _
 Button As Integer)
